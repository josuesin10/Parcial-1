    ...
    <header>
        ...
        <div class="pantalla-blanca">
            ...
            <ul style="text-align: left; margin-left: 150px;">
                <p>En este sitio encontraras o siguiente: </p>
                <li >
                    Página para el problema "BIT DE PARIDAD".<br>
                </li>
                <li>
                    Página para el problema "AUTORES". <br>
                </li>
                <li>
                    Página para el problema "ADQUISICIÓN DE LETRAS".
                </li>
            </ul>
        </div>
    </header>
